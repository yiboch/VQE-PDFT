...
point2_e318, qmmmobject = SP.singlepoint(filename=pdb_dir+'/optimized-372p318n.pdb',
                                         qmatomlist=qmatomlist318, qm_charge=1, qm_mult=2,
                                         act_nelec=3, act_norb=3, label='point2-318p')

qm_charge_318 = qmmmobject.qm_theory.qm_mulliken_charge[:-1]

print('='*35)
print("p2_318:", point2_e318)
print('='*35)
