...
import pickle
filename = cur_dir+"/qm_charge_318.pkl"
with open(filename, 'rb') as f:
    data = pickle.load(f)

qm_charge_318 = data["qm_charge_318"]

point2_e372, _ = SP.singlepoint(filename=pdb_dir+'/optimized-372p318n.pdb',
                                qmatomlist=qmatomlist372, qm_charge=0, qm_mult=1,
                                set_atom_list=qmatomlist318, set_atom_charges=qm_charge_318,
                                act_nelec=4, act_norb=3, label='point2-372n')

print('='*35)
print("p2_372:", point2_e372)
print('='*35)
