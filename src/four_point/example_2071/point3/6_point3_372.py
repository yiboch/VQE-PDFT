...
point3_e372, _ = SP.singlepoint(filename=pdb_dir+'/optimized-372n318p.pdb',
                                qmatomlist=qmatomlist372, qm_charge=0, qm_mult=1,
                                set_atom_list=qmatomlist318, set_atom_charges=qm_charge_318,
                                act_nelec=4, act_norb=3, label='point3-372n')

print('='*35)
print("p3_372:", point3_e372)
print('='*35)
