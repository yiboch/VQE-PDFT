...
point1_e318, _ = SP.singlepoint(filename=pdb_dir+'/optimized-372p318n.pdb',
                                qmatomlist=qmatomlist318, qm_charge=0, qm_mult=1,
                                set_atom_list=qmatomlist372, set_atom_charges=qm_charge_372,
                                act_nelec=4, act_norb=3, label='point1-318n')

print('='*35)
print("p1_318:", point1_e318)
print('='*35)
