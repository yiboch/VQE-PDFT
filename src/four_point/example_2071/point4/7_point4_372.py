...
point4_e372, qmmmobject = SP.singlepoint(filename=pdb_dir+'/optimized-372n318p.pdb',
                                         qmatomlist=qmatomlist372, qm_charge=1, qm_mult=2,
                                         act_nelec=3, act_norb=3, label='point4-372p')

qm_charge_372 = qmmmobject.qm_theory.qm_mulliken_charge[:-1]

print('='*35)
print("p4_372:", point4_e372)
print('='*35)
